...
write(fname,'(2A)') trim(path),"/ERA5/surface_geopotential.nc"
...
do yr=ts,te
  ...
  write(fname,'(2A,I4,A)') trim(path),"/ERA5/SP/SP_",yr,".nc"
  ...
  ierr=nf90_inq_varid(ncid2,"lon",varid1) 
  ...
  ierr=nf90_inq_varid(ncid2,"lat",varid1) 
